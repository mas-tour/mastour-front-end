...
// Ini dari referensi, gak kupake sih..

interface UploadRepository {
    suspend fun uploadFile(uri: Uri, title: String? = null): Result<Upload>
}

class UploadRepositoryImp(private val imgurApi: ImgurApiService, private val contentResolver: ContentResolver): UploadRepository{
